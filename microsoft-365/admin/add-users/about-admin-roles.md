...
|---------|---------|
| AI administrator |  Assign the AI Administrator role to users who need to see and manage all aspects of Microsoft 365 Copilot, AI-related enterprise services, extensibility, and copilot agents from the Integrated apps page in the Microsoft 365 admin center |
