...
You can download products that you bought via volume licensing either as Executable (EXE) files  or as ISO (International Standards Organization) image files from the **Downloads** page in the Microsoft 365 admin center.

## Before you begin

- You must have the Administrator or Product download manager volume licensing role for the corresponding licensing ID to access downloads in the Microsoft 365 admin center. For information about VL roles, see [Manage volume licensing user roles Frequently Asked Questions](user-roles-faq.yml).
- You must have, or buy, a license for the products that you plan to download.
- To install volume licensing download files, you might need a valid product key.  
- You must have either the Administrator or Product key view role to access volume licensing product keys.
...
If you want to exercise your volume licensing "downgrade right" to use prior versions of the software edition that you've licensed but are no longer available as Microsoft volume licensing downloads, you might be able to source CD/DVD media from past shipments of "comprehensive kits" or "subscription kits" that you received. Alternatively, your Microsoft Resellers might still have inventory. However, Microsoft doesn't provide physical media for products bought through volume licensing contracts
