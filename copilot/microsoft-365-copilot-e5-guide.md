...
When you're preparing your organization for [Microsoft 365 Copilot](microsoft-365-copilot-overview.md) or are ready to start using Copilot now, there are features in your E5 license that can help get your data ready.
...
This article provides guidance for IT admins with a **Microsoft 365 E5** and **SharePoint Advanced Management (SAM)** licenses. With the features included in these licenses, you:
